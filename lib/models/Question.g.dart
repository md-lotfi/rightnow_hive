...
Map<String, dynamic> _$QuestionToJson(Question instance) => <String, dynamic>{
      ...
      'updated': const JiffySecondsConverter().toJson(instance.updated),
