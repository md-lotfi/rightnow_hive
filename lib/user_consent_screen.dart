                ...
                children: [
                  ...
                  Expanded(
                    child: RichText(
                      text: TextSpan(
                        text:
                            "Je consens à ce que FahS utilise les données santé que je divulgue ici volontairement, afin de créer et personnaliser mon compte et fournir des évaluations et orientations en matière de santé."
                                .tr(),
                        style: TextStyle(
                          color: Color(0xFF707070),
                          fontFamily: "PoppinsRegular",
